...
assert(normalizedServerAddress("192.168.1.20:3150")?.absoluteString == "http://192.168.1.20:3150")
assert(normalizedServerAddress("  http://192.168.1.20:3150/  ")?.absoluteString == "http://192.168.1.20:3150/")
assert(normalizedServerAddress("library.example") == nil)
assert(normalizedServerAddress("https://library.example")?.absoluteString == "https://library.example")
assert(serverConnectionMessage(URLError(.secureConnectionFailed),server:URL(string:"https://192.168.1.20:3150")!)?.contains("http://192.168.1.20:3150") == true)
assert(serverConnectionMessage(URLError(.notConnectedToInternet),server:URL(string:"http://192.168.1.20:3150")!)?.contains("Local Network") == true)
