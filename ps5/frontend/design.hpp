...
struct Tokens {
  ...
  static constexpr float radius=8,pillRadius=32,focusScale=1.018f,focusSeconds=.12f,fadeSeconds=.28f;
  static constexpr int caption=19,control=22,body=24,heading=26,title=54,compactTitle=36,brand=39;
  static constexpr SDL_Color white{244,246,250,255},muted{195,204,217,255},accent{139,192,245,255};
  static constexpr SDL_Color background{7,11,17,255},surface{39,49,63,174},focus{174,217,255,255};
};
